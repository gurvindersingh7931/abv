...
<nav class="navbar is-fixed-top navbar-static-top is-primary" role="navigation">
    ...
    <div class="navbar-item has-dropdown is-hoverable">
        <!-- {{count(Auth::user()->unreadNotifications->where('type', 'App\Notifications\IssueAdded'))}} -->
        <a class="navbar-item" href="#">
            <span class="icon">
                <i class="fa fa-bell" style="color: green">{{count(Auth::user()->unreadNotifications)}}</i>
            </span>
        </a>
        ...
        <div class="navbar-dropdown is-boxed">
            ...
            <form method="get" action="/issue/notifications/read/{{ $notification['notifiable_id'] }}/{{$notification['data']['task_id']}}">
                ...
                <input type="submit" class="form-control submitLink" value="New Issue Added:{{$notification['data']['user_name']}} : {{$notification['data']['project_title']}} : {{$notification['data']['message']}}" style="color: black; border: none">
            ...
            <form method="get" action="/comment/notifications/read/{{ $notification['notifiable_id'] }}/{{$notification['data']['issue_id']}}/{{$notification['data']['task_id']}}">
                ...
                <input type="submit" class="navbar-item submitLink form-control" value="Comment added: {{$notification['data']['user_name']}} : {{$notification['data']['project_title']}} : {{$notification['data']['issue_title']}}">
