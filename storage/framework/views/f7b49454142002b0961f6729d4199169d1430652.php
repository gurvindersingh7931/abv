...
<nav class="navbar is-fixed-top navbar-static-top is-primary" role="navigation">
    ...
    <div class="navbar-item has-dropdown is-hoverable">
        <!-- <?php echo e(count(Auth::user()->unreadNotifications->where('type', 'App\Notifications\IssueAdded'))); ?> -->
        <a class="navbar-item" href="#">
            <span class="icon">
                <i class="fa fa-bell" style="color: green"><?php echo e(count(Auth::user()->unreadNotifications)); ?></i>
            </span>
        </a>
        ...
        <div class="navbar-dropdown is-boxed">
            ...
            <form method="get" action="/issue/notifications/read/<?php echo e($notification['notifiable_id']); ?>/<?php echo e($notification['data']['task_id']); ?>">
                ...
                <input type="submit" class="form-control submitLink" value="New Issue Added:<?php echo e($notification['data']['user_name']); ?> : <?php echo e($notification['data']['project_title']); ?> : <?php echo e($notification['data']['message']); ?>" style="color: black; border: none">
            ...
            <form method="get" action="/comment/notifications/read/<?php echo e($notification['notifiable_id']); ?>/<?php echo e($notification['data']['issue_id']); ?>/<?php echo e($notification['data']['task_id']); ?>">
                ...
                <input type="submit" class="navbar-item submitLink form-control" value="Comment added: <?php echo e($notification['data']['user_name']); ?> : <?php echo e($notification['data']['project_title']); ?> : <?php echo e($notification['data']['issue_title']); ?>">
...
<!--                             <?php if(Auth::user()->privilage == 2): ?>
                            ...
                            <?php endif; ?>
                            <li>
                                <a class="navbar-item" href="https://www.google.com/calendar">Calender</a>
                            </li>
                            <li>
